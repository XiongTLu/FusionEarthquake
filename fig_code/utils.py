"""
Utility Functions for NPP-ETAS Log-Likelihood and Catalog Processing

This module contains helper functions used in log-likelihood computation,
catalog filtering, time conversion, and Poisson model comparison for the 
NPP-ETAS earthquake forecasting framework.

Key functionalities include:
- Log-likelihood collation for irregular events
- Time windowing for burn-in augmentation
- Poisson baseline likelihood estimation
- Frequency-Magnitude Distribution (FMD) analysis
