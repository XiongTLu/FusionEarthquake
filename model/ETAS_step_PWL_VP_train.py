...
def main():
    ...
    etas_train_mag_file = f'ETAS_PWL_VP_train_mag_Mcut{Mcut}_params{params_cut}_{earthquake}.csv'
    ...
    etas_test_mag_file = f'ETAS_PWL_VP_test_mag_Mcut{Mcut}_params{params_cut}_{earthquake}.csv'
    ...
    etas_train_time_file = f'ETAS_PWL_VP_train_time_Mcut{Mcut}_params{params_cut}_{earthquake}.csv'
    ...
    etas_test_time_file = f'ETAS_PWL_VP_test_time_Mcut{Mcut}_params{params_cut}_{earthquake}.csv'
    ...
    # =========================================================
    #           ETAS-PWL VP 的时间 / 震级 mean LL
    # =========================================================
    time_mean = float(np.mean(test_time_ll_pred))
    mag_mean  = float(np.mean(test_mag_ll_pred))

    print("\n[ETAS-PWL VP mean log-likelihoods | burn-in removed + masked by M>=M0pred]")
    print(f"ETAS-PWL VP test  time      mean LL (masked): {time_mean:.6f}  (n={len(test_time_ll_pred)})")
    print(f"ETAS-PWL VP test  magnitude mean LL (masked): {mag_mean:.6f}  (n={len(test_mag_ll_pred)})")
