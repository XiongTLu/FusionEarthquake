...
def main():
    ...
    ckp_dir = './ckp_Fusion_trunc_fixed_zhang_seed/'
    os.makedirs(ckp_dir, exist_ok=True)

    checkpoint = f'ckp_Fusion_trunc_fixed_zhang_Mcut{Mcut}_{earthquake}_seed{seed}.h5'
    ...
    # # # # # # # # # # # # #  Testing  # # # # # # # # # # # #
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    result_path = './results_Fusion_trunc_fixed_zhang_seed/'
    os.makedirs(result_path, exist_ok=True) 
    result_file = f'results_Fusion_trunc_fixed_zhang_Mcut{Mcut}_{earthquake}_seed{seed}.csv'
    path_to_results = os.path.join(result_path, result_file)

    pred_path = './pred_Fusion_trunc_fixed_zhang_seed/'
    os.makedirs(pred_path, exist_ok=True)
    pred_file = f'pred_Fusion_trunc_fixed_zhang_Mcut{Mcut}_{earthquake}_seed{seed}.csv'
