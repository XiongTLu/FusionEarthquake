...
def main():
    ...
    ############# Neural Network
    ckp_dir = './ckp_NPP_PWL_score_fixed_seed/'
    os.makedirs(ckp_dir, exist_ok=True)

    checkpoint = f'ckp_NPP_PWL_score_fixed_Mcut{Mcut}_{earthquake}_seed{seed}.h5'
    ...
    # # # # # # # # # # # # #  Testing  # # # # # # # # # # # # # 
    # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    result_path = './results_NPP_PWL_score_fixed_seed/'
    os.makedirs(result_path, exist_ok=True)
    result_file = f'results_NPP_PWL_score_fixed_Mcut{Mcut}_{earthquake}_seed{seed}.csv'
    path_to_results = os.path.join(result_path, result_file)

    pred_path = './pred_NPP_PWL_score_fixed_seed/'
    os.makedirs(pred_path, exist_ok=True)
    pred_file = f'pred_NPP_PWL_score_fixed_Mcut{Mcut}_{earthquake}_seed{seed}.csv'
    ...
    ##### NN
        ...
        print('NPP_PWL_score_fixed Temporal Likelihood:   ' + str(npp.collated_LLtime.mean()))
        print('NPP_PWL_score_fixed Mark Likelihood:  '+str(npp.collated_LLmag.mean()))
        ...
        print('NPP_PWL_score_fixed Mark Likelihood:  '+str(npp.NPP_mag_like.mean()))
