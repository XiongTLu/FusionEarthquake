...
def compute_Fusion_trunc(earthquake, Mcut):
    ...
    path = f'./results_Fusion_trunc_VP_seed'
    results_file_name = (
        f'results_Fusion_trunc_VP_Mcut{Mcut}_{earthquake}_seed{seed}.csv'
    )
...
def main():
    ...
    for earthquake in earthquakes:
        ...
        for Mcut in mcuts:
            ...
            rows.append({
                'Mcut': Mcut,
                f'Fusion_VP_time_LL': time_LL,
                f'Fusion_VP_mag_LL': mag_LL,
                'Poisson_LL': poiss_LL,
            })
        ...
        out_path = os.path.join(
            out_dir,
            f"summary_Fusion_VP_seed1_{earthquake}.csv"
        )
