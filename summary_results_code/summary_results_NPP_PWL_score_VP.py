...
def compute_NPP_PWL(earthquake, Mcut):
    ...
    path = f'./results_NPP_PWL_score_VP_seed'
    results_file_name = f'results_NPP_PWL_score_VP_Mcut{Mcut}_{earthquake}_seed{seed}.csv'
...
def main():
    ...
    for earthquake in earthquakes:
        ...
        for Mcut in mcuts:
            ...
            rows.append({
                'Mcut': Mcut,
                'NPP_PWL_score_VP_time_LL': time_LL,
                'NPP_PWL_score_VP_mag_LL': mag_LL,
                'Poisson_LL': poiss_LL,
            })
        ...
        out_path = os.path.join(
            out_dir,
            f"summary_NPP_PWL_score_VP_seed1_{earthquake}.csv"
        )
